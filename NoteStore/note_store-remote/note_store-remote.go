...
import (
	...
	"github.com/aliabdullahcp/evernote-golang-sdk/NoteStore"
...
func main() {
	...
	case "getSyncState":
		...
		value0 := argvalue0
		fmt.Print(client.GetSyncState(ctx, value0))
		fmt.Print("\n")
		break
	case "getSyncStateWithMetrics":
		...
		err349 := argvalue1.Read(ctx, jsProt348)
		if err349 != nil {
			Usage()
			return
		}
		value1 := argvalue1
		fmt.Print(client.GetSyncStateWithMetrics(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getSyncChunk":
		if flag.NArg()-1 != 4 {
		...
		value3 := argvalue3
		fmt.Print(client.GetSyncChunk(ctx, value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "getFilteredSyncChunk":
		...
		err362 := argvalue3.Read(ctx, jsProt361)
		if err362 != nil {
			Usage()
			return
		}
		value3 := argvalue3
		fmt.Print(client.GetFilteredSyncChunk(ctx, value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "getLinkedNotebookSyncState":
		...
		// err369 := argvalue1.Read(ctx, jsProt368)
		// if err369 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.GetLinkedNotebookSyncState(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getLinkedNotebookSyncChunk":
		...
		// argvalue1 := NoteStore.NewLinkedNotebook()
		// err376 := argvalue1.Read(ctx, jsProt375)
		// if err376 != nil {
		// 	Usage()
		// 	return
		// }
		...
		// value4 := argvalue4
		// fmt.Print(client.GetLinkedNotebookSyncChunk(ctx, value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "listNotebooks":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.ListNotebooks(ctx, value0))
		fmt.Print("\n")
		break
	case "getNotebook":
		if flag.NArg()-1 != 2 {
		...
		// fmt.Print(client.GetNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getDefaultNotebook":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.GetDefaultNotebook(ctx, value0))
		fmt.Print("\n")
		break
	case "createNotebook":
		if flag.NArg()-1 != 2 {
		...
		// err390 := argvalue1.Read(ctx, jsProt389)
		// if err390 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.CreateNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "updateNotebook":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := NoteStore.NewNotebook()
		// err397 := argvalue1.Read(ctx, jsProt396)
		// if err397 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.UpdateNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "expungeNotebook":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.ExpungeNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "listTags":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.ListTags(ctx, value0))
		fmt.Print("\n")
		break
	case "listTagsByNotebook":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.ListTagsByNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getTag":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetTag(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "createTag":
		if flag.NArg()-1 != 2 {
		...
		// err411 := argvalue1.Read(ctx, jsProt410)
		// if err411 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.CreateTag(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "updateTag":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := NoteStore.NewTag()
		// err418 := argvalue1.Read(ctx, jsProt417)
		// if err418 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.UpdateTag(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "untagAll":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.UntagAll(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "expungeTag":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.ExpungeTag(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "listSearches":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.ListSearches(ctx, value0))
		fmt.Print("\n")
		break
	case "getSearch":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetSearch(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "createSearch":
		if flag.NArg()-1 != 2 {
		...
		// err432 := argvalue1.Read(ctx, jsProt431)
		// if err432 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.CreateSearch(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "updateSearch":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := NoteStore.NewSavedSearch()
		// err439 := argvalue1.Read(ctx, jsProt438)
		// if err439 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.UpdateSearch(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "expungeSearch":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.ExpungeSearch(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "findNotes":
		if flag.NArg()-1 != 4 {
		...
		err448 := argvalue1.Read(ctx, jsProt447)
		if err448 != nil {
			Usage()
			return
		}
		...
		argvalue3 := int32(tmp3)
		value3 := argvalue3
		fmt.Print(client.FindNotes(ctx, value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "findNoteOffset":
		if flag.NArg()-1 != 3 {
		...
		argvalue1 := NoteStore.NewNoteFilter()
		err457 := argvalue1.Read(ctx, jsProt456)
		if err457 != nil {
			Usage()
			return
		}
		...
		// fmt.Print(client.FindNoteOffset(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "findNotesMetadata":
		...
		argvalue1 := NoteStore.NewNoteFilter()
		err465 := argvalue1.Read(ctx, jsProt464)
		if err465 != nil {
			Usage()
			return
		}
		...
		err473 := argvalue4.Read(ctx, jsProt472)
		if err473 != nil {
			Usage()
			return
		}
		value4 := argvalue4
		fmt.Print(client.FindNotesMetadata(ctx, value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "findNoteCounts":
		if flag.NArg()-1 != 3 {
		...
		argvalue1 := NoteStore.NewNoteFilter()
		err480 := argvalue1.Read(ctx, jsProt479)
		if err480 != nil {
			Usage()
			return
		}
		...
		value2 := argvalue2
		fmt.Print(client.FindNoteCounts(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "getNote":
		if flag.NArg()-1 != 6 {
		...
		// value5 := argvalue5
		// fmt.Print(client.GetNote(ctx, value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "getNoteApplicationData":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetNoteApplicationData(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getNoteApplicationDataEntry":
		...
		// argvalue2 := flag.Arg(3)
		// value2 := argvalue2
		// fmt.Print(client.GetNoteApplicationDataEntry(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "setNoteApplicationDataEntry":
		...
		// value3 := argvalue3
		// fmt.Print(client.SetNoteApplicationDataEntry(ctx, value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "unsetNoteApplicationDataEntry":
		...
		// argvalue2 := flag.Arg(3)
		// value2 := argvalue2
		// fmt.Print(client.UnsetNoteApplicationDataEntry(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "getNoteContent":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetNoteContent(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getNoteSearchText":
		...
		// argvalue3 := flag.Arg(4) == "true"
		// value3 := argvalue3
		// fmt.Print(client.GetNoteSearchText(ctx, value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "getResourceSearchText":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetResourceSearchText(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getNoteTagNames":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetNoteTagNames(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "createNote":
		if flag.NArg()-1 != 2 {
		...
		// err516 := argvalue1.Read(ctx, jsProt515)
		// if err516 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.CreateNote(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "updateNote":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := NoteStore.NewNote()
		// err523 := argvalue1.Read(ctx, jsProt522)
		// if err523 != nil {
		// Usage()
		// return
		// }
		// value1 := argvalue1
		// fmt.Print(client.UpdateNote(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "deleteNote":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.DeleteNote(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "expungeNote":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.ExpungeNote(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "expungeNotes":
		if flag.NArg()-1 != 2 {
		...
		value1 := argvalue1
		fmt.Print(client.ExpungeNotes(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "expungeInactiveNotes":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.ExpungeInactiveNotes(ctx, value0))
		fmt.Print("\n")
		break
	case "copyNote":
		if flag.NArg()-1 != 3 {
		...
		// argvalue2 := flag.Arg(3)
		// value2 := NoteStore.Guid(argvalue2)
		// fmt.Print(client.CopyNote(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "listNoteVersions":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.ListNoteVersions(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getNoteVersion":
		if flag.NArg()-1 != 6 {
		...
		// argvalue5 := flag.Arg(6) == "true"
		// value5 := argvalue5
		// fmt.Print(client.GetNoteVersion(ctx, value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "getResource":
		if flag.NArg()-1 != 6 {
		...
		// argvalue5 := flag.Arg(6) == "true"
		// value5 := argvalue5
		// fmt.Print(client.GetResource(ctx, value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "getResourceApplicationData":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetResourceApplicationData(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getResourceApplicationDataEntry":
		...
		// argvalue2 := flag.Arg(3)
		// value2 := argvalue2
		// fmt.Print(client.GetResourceApplicationDataEntry(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "setResourceApplicationDataEntry":
		...
		// argvalue3 := flag.Arg(4)
		// value3 := argvalue3
		// fmt.Print(client.SetResourceApplicationDataEntry(ctx, value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "unsetResourceApplicationDataEntry":
		...
		// argvalue2 := flag.Arg(3)
		// value2 := argvalue2
		// fmt.Print(client.UnsetResourceApplicationDataEntry(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "updateResource":
		if flag.NArg()-1 != 2 {
		...
		// err571 := argvalue1.Read(ctx, jsProt570)
		// if err571 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.UpdateResource(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getResourceData":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetResourceData(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getResourceByHash":
		...
		// argvalue5 := flag.Arg(6) == "true"
		// value5 := argvalue5
		// fmt.Print(client.GetResourceByHash(ctx, value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "getResourceRecognition":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetResourceRecognition(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getResourceAlternateData":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetResourceAlternateData(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getResourceAttributes":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.GetResourceAttributes(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getPublicNotebook":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := argvalue1
		// fmt.Print(client.GetPublicNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "createSharedNotebook":
		...
		// err594 := argvalue1.Read(ctx, jsProt593)
		// if err594 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.CreateSharedNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "updateSharedNotebook":
		...
		// argvalue1 := NoteStore.NewSharedNotebook()
		// err601 := argvalue1.Read(ctx, jsProt600)
		// if err601 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.UpdateSharedNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "setSharedNotebookRecipientSettings":
		...
		// err609 := argvalue2.Read(ctx, jsProt608)
		// if err609 != nil {
		// 	Usage()
		// 	return
		// }
		// value2 := argvalue2
		// fmt.Print(client.SetSharedNotebookRecipientSettings(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "sendMessageToSharedNotebookMembers":
		...
		// value3 := argvalue3
		// fmt.Print(client.SendMessageToSharedNotebookMembers(ctx, value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "listSharedNotebooks":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.ListSharedNotebooks(ctx, value0))
		fmt.Print("\n")
		break
	case "expungeSharedNotebooks":
		...
		value1 := argvalue1
		fmt.Print(client.ExpungeSharedNotebooks(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "createLinkedNotebook":
		...
		// argvalue1 := NoteStore.NewLinkedNotebook()
		// err633 := argvalue1.Read(ctx, jsProt632)
		// if err633 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.CreateLinkedNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "updateLinkedNotebook":
		...
		// argvalue1 := NoteStore.NewLinkedNotebook()
		// err640 := argvalue1.Read(ctx, jsProt639)
		// if err640 != nil {
		// 	Usage()
		// 	return
		// }
		// value1 := argvalue1
		// fmt.Print(client.UpdateLinkedNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "listLinkedNotebooks":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.ListLinkedNotebooks(ctx, value0))
		fmt.Print("\n")
		break
	case "expungeLinkedNotebook":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.ExpungeLinkedNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "authenticateToSharedNotebook":
		...
		argvalue1 := flag.Arg(2)
		value1 := argvalue1
		fmt.Print(client.AuthenticateToSharedNotebook(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "getSharedNotebookByAuth":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.GetSharedNotebookByAuth(ctx, value0))
		fmt.Print("\n")
		break
	case "emailNote":
		if flag.NArg()-1 != 2 {
		...
		err653 := argvalue1.Read(ctx, jsProt652)
		if err653 != nil {
			Usage()
			return
		}
		value1 := argvalue1
		fmt.Print(client.EmailNote(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "shareNote":
		if flag.NArg()-1 != 2 {
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.ShareNote(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "stopSharingNote":
		...
		// argvalue1 := flag.Arg(2)
		// value1 := NoteStore.Guid(argvalue1)
		// fmt.Print(client.StopSharingNote(ctx, value0, value1))
		fmt.Print("\n")
		break
	case "authenticateToSharedNote":
		...
		argvalue2 := flag.Arg(3)
		value2 := argvalue2
		fmt.Print(client.AuthenticateToSharedNote(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "findRelated":
		if flag.NArg()-1 != 3 {
		...
		err667 := argvalue1.Read(ctx, jsProt666)
		if err667 != nil {
			Usage()
			return
		}
		...
		err673 := argvalue2.Read(ctx, jsProt672)
		if err673 != nil {
			Usage()
			return
		}
		value2 := argvalue2
		fmt.Print(client.FindRelated(ctx, value0, value1, value2))
		fmt.Print("\n")
		break
	case "":
		Usage()

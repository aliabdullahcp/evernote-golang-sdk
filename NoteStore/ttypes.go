...
func (p *ClientUsageMetrics) Read(ctx context.Context, iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(ctx); err != nil {
		return fmt.Errorf("%T read error", p)
	}
	for {
...
func (p *ClientUsageMetrics) readField1(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(ctx); err != nil {
		return fmt.Errorf("error reading field 1: %s")
	} else {
		p.Sessions = v
...
func (p *ClientUsageMetrics) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "ClientUsageMetrics"); err != nil {
		return fmt.Errorf("%T write struct begin error: %s", p, err)
	}
	if err := p.writeField1(ctx, oprot); err != nil {
		return err
...
func (p *ClientUsageMetrics) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetSessions() {
		if err := oprot.WriteFieldBegin(ctx, "sessions", thrift.I32, 1); err != nil {
			return fmt.Errorf("%T write field begin error 1:sessions: %s", p, err)
		}
		if err := oprot.WriteI32(ctx, int32(p.Sessions)); err != nil {
...
func (p *RelatedResult) readField1(ctx context.Context, iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin(ctx)
	if err != nil {
		return fmt.Errorf("error reading list being: %s")
	}
...
func (p *RelatedResult) readField2(ctx context.Context, iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin(ctx)
	if err != nil {
		return fmt.Errorf("error reading list being: %s")
	}
...
func (p *RelatedResult) readField3(ctx context.Context, iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin(ctx)
	if err != nil {
		return fmt.Errorf("error reading list being: %s")
	}
...
func (p *RelatedResult) readField4(ctx context.Context, iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin(ctx)
	if err != nil {
		return fmt.Errorf("error reading list being: %s")
	}
...
func (p *RelatedResult) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.Notes != nil {
		if p.IsSetNotes() {
...
func (p *RelatedResult) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.Notebooks != nil {
		if p.IsSetNotebooks() {
...
func (p *RelatedResult) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.Tags != nil {
		if p.IsSetTags() {
...
func (p *RelatedResult) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {

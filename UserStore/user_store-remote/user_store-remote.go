...
func main() {
	...
	case "checkVersion":
		...
		argvalue2 := byte(tmp2)
		value2 := argvalue2
		fmt.Println(client.CheckVersion(ctx, value0, int16(value1), int16(value2)))
		fmt.Print("\n")
		break
	case "getBootstrapInfo":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Println(client.GetBootstrapInfo(ctx, value0))
		fmt.Print("\n")
		break
	case "authenticate":
		if flag.NArg()-1 != 5 {
		...
		value4 := argvalue4
		fmt.Print(client.Authenticate(ctx, value0, value1, value2, value3, value4))
		fmt.Print("\n")
		break
	case "authenticateLongSession":
		...
		value6 := argvalue6
		fmt.Print(client.AuthenticateLongSession(ctx, value0, value1, value2, value3, value4, value5, value6))
		fmt.Print("\n")
		break
	case "completeTwoFactorAuthentication":
		...
		argvalue3 := flag.Arg(4)
		value3 := argvalue3
		fmt.Print(client.CompleteTwoFactorAuthentication(ctx, value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "revokeLongSession":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.RevokeLongSession(ctx, value0))
		fmt.Print("\n")
		break
	case "authenticateToBusiness":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.AuthenticateToBusiness(ctx, value0))
		fmt.Print("\n")
		break
	case "refreshAuthentication":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.RefreshAuthentication(ctx, value0))
		fmt.Print("\n")
		break
	case "getUser":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.GetUser(ctx, value0))
		fmt.Print("\n")
		break
	case "getPublicUserInfo":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.GetPublicUserInfo(ctx, value0))
		fmt.Print("\n")
		break
	case "getPremiumInfo":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.GetPremiumInfo(ctx, value0))
		fmt.Print("\n")
		break
	case "getNoteStoreUrl":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.GetNoteStoreUrl(ctx, value0))
		fmt.Print("\n")
		break
	case "":
		Usage()

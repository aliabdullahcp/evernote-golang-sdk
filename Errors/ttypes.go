...
func (p *EDAMUserException) Read(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *EDAMUserException) readField1(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *EDAMUserException) readField2(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *EDAMUserException) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "EDAMUserException"); err != nil {
...
func (p *EDAMUserException) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetErrorCode() {
...
func (p *EDAMUserException) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetParameter() {
		if err := oprot.WriteFieldBegin(ctx, "parameter", thrift.STRING, 2); err != nil {
			return fmt.Errorf("%T write field begin error 2:parameter: %s", p, err)
		}
		if err := oprot.WriteString(ctx, string(p.Parameter)); err != nil {
...
func (p *EDAMSystemException) Read(ctx context.Context, iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(ctx); err != nil {
		return fmt.Errorf("%T read error", p)
	}
	for {
...
func (p *EDAMSystemException) readField1(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(ctx); err != nil {
		return fmt.Errorf("error reading field 1: %s", err)
	} else {
		p.ErrorCode = EDAMErrorCode(v)
...
func (p *EDAMSystemException) readField2(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(ctx); err != nil {
		return fmt.Errorf("error reading field 2: %s", err)
	} else {
		p.Message = v
...
func (p *EDAMSystemException) readField3(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(ctx); err != nil {
...
func (p *EDAMSystemException) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "EDAMSystemException"); err != nil {
		return fmt.Errorf("%T write struct begin error: %s", p, err)
	}
	if err := p.writeField1(ctx, oprot); err != nil {
		return err
...
func (p *EDAMSystemException) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetErrorCode() {
		if err := oprot.WriteFieldBegin(ctx, "errorCode", thrift.I32, 1); err != nil {
			return fmt.Errorf("%T write field begin error 1:errorCode: %s", p, err)
		}
...
func (p *EDAMSystemException) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetMessage() {
...
func (p *EDAMSystemException) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetRateLimitDuration() {
		if err := oprot.WriteFieldBegin(ctx, "rateLimitDuration", thrift.I32, 3); err != nil {
			return fmt.Errorf("%T write field begin error 3:rateLimitDuration: %s", p, err)
		}
		if err := oprot.WriteI32(ctx, int32(p.RateLimitDuration)); err != nil {
...
func (p *EDAMNotFoundException) Read(ctx context.Context, iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(ctx); err != nil {
		return fmt.Errorf("%T read error", p)
	}
	for {
...
func (p *EDAMNotFoundException) readField1(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(ctx); err != nil {
...
func (p *EDAMNotFoundException) readField2(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(ctx); err != nil {
...
func (p *EDAMNotFoundException) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "EDAMNotFoundException"); err != nil {
		return fmt.Errorf("%T write struct begin error: %s", p, err)
	}
	if err := p.writeField1(ctx, oprot); err != nil {
		return err
...
func (p *EDAMNotFoundException) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetIdentifier() {
		if err := oprot.WriteFieldBegin(ctx, "identifier", thrift.STRING, 1); err != nil {
...
func (p *EDAMNotFoundException) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetKey() {
